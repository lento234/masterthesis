...
# Plot mesh
py.triplot(xFEI,yFEI,'-',color='0.7',lw=1,zorder=1)


# Plot the structured grid
py.plot(xStructured,yStructured,'-',color='c',zorder=3,lw=1.)
py.plot(xStructured.T,yStructured.T,'-',color='c',zorder=3,lw=1.)

# Plot boundarries
py.plot(xyEllipse[0],xyEllipse[1],'-',color='k',zorder=10,lw=1)
py.plot(xyFEBoundary[0],xyFEBoundary[1],'-',color='k',zorder=2,lw=1)

# Plot square
ax.add_patch(mpl.patches.PathPatch(ellipse,fill=True,lw=0,facecolor='LightGrey',edgecolor='None',zorder=10))
...
# Add notation
ax.text(-2.2,1.2,r'\textsf{4.a}',fontsize=15,zorder=50)                           
ax.add_patch(mpl.patches.Circle((-2,1.3),0.25,fc='0.9',zorder=50))


py.plot(xyFEBoundary[0],xyFEBoundary[1],'k-',lw=0.5,zorder=2)
py.plot(xyBoundaryPoly[0],xyBoundaryPoly[1],'r--',lw=1,zorder=5)
py.plot(xySurfacePoly[0],xySurfacePoly[1],'r--',lw=1,zorder=5)
...
#
#
#py.plot([0.,rotate([1.5,0.])[0]], [0.,rotate([1.5,0.])[1]], 'k--', lw=1.5,zorder=20) 
#py.plot([0,1.5],[0,0],'k--',lw=1.5,zorder=20)


#ax.annotate(r"$x'$", xy=rotate([0.5, 0.15]),fontsize=15,zorder=10,backgroundcolor='w')
#ax.annotate(r"$y'$", xy=rotate([-0.3, 0.5]),fontsize=15,zorder=10,backgroundcolor='w')
#ax.annotate(r'$\theta_{\mathrm{loc}}$', xy=[1.2,0.2],fontsize=20,zorder=20,backgroundcolor='w')
#
#

ax.annotate(r"$\mathrm{SG}$", xy=[0.214,-2.35],fontsize=20,zorder=10,backgroundcolor='w')

ax.annotate("", xy=(xStructured[0][3], yStructured[0][3]), xycoords='data',
                xytext=[0.214,-2.235], textcoords='data',
            arrowprops=dict(arrowstyle="-", color="k", shrinkA=0, shrinkB=0,
                            patchA=None, patchB=None,
                            connectionstyle="arc3,rad=-0.2",),)


ax.annotate(r"$(x_{\mathrm{SG}}'^{\mathrm{LB}}, y_{\mathrm{SG}}'^{\mathrm{LB}})$", xy=(-1.655,-2.758),fontsize=10,zorder=15)
...
py.axis('off')
py.savefig('assignStrength_part1.pdf')
...
XL,YL = rotate([XL,YL],theta=-30)

# Plot the blobs inside
py.scatter(XL,YL,s=150,c='w',lw=1,zorder=5)
#py.scatter(XL,YL,s=100,c='w',lw=1,zorder=5)
py.scatter(XL[11],YL[11],s=150,c='gray',lw=0.5,zorder=5)


# Plot boundaries
xyBoundaryPoly = rotate(xyBoundaryPoly,theta=-30)
xySurfacePoly = rotate(xySurfacePoly,theta=-30)

py.plot(xyBoundaryPoly[0],xyBoundaryPoly[1],'k--',lw=1,zorder=5)
py.plot(xySurfacePoly[0],xySurfacePoly[1],'k--',lw=1,zorder=5)


xCell = [xStructured[0][4],xStructured[0][5],xStructured[0][5],xStructured[0][4],xStructured[0][4]]
yCell = [yStructured[3][0],yStructured[3][0],yStructured[4][0],yStructured[4][0],yStructured[3][0]]

py.plot(xCell,yCell,'r--',lw=1.5,zorder=100)

cell = mpl.path.Path(np.vstack((xCell,yCell)).T,closed=True)

# Plot square
ax.add_patch(mpl.patches.PathPatch(cell,fill=True,lw=0,facecolor='LightPink',zorder=1))


# Add notation
ax.text(-2-0.5,1.35,r'\textsf{4.b}',fontsize=15,zorder=50)                           
ax.add_patch(mpl.patches.Circle((-1.9-0.5,1.4),0.15,fc='0.9',zorder=50))
...
#ax.annotate(r"$x'$", xy=rotate([0.5, 0.15]),fontsize=15,zorder=10,backgroundcolor='w')
#ax.annotate(r"$y'$", xy=rotate([-0.3, 0.5]),fontsize=15,zorder=10,backgroundcolor='w')
ax.annotate(r'$\mathbf{d}_p$', xy=[-1.65,-1.1],fontsize=25,zorder=20)#,backgroundcolor='w')
#
#
ax.annotate("", xy=(xStructured[0,0], yStructured[0,0]), xycoords='data',zorder=50,fontsize=30,
                xytext=(XL[11],YL[11]), textcoords='data',
            arrowprops=dict(arrowstyle="<|-", color="k", shrinkA=5, shrinkB=0,
                            patchA=None, patchB=None,
                            connectionstyle="arc3,rad=-0.",),)


ax.annotate(r'$i$', xy=[-1.65+0.4,yStructured[0,0]-0.25],fontsize=15,zorder=20)#,backgroundcolor='w')
ax.annotate(r'$j$', xy=[xStructured[0,0]-0.25,-1.1+0.25],fontsize=15,zorder=20)#,backgroundcolor='w')

ax.annotate("", xy=(xStructured[0,0]+1, yStructured[0,0]-0.2), xycoords='data',zorder=50,fontsize=10,
                xytext=(xStructured[0,0]+1.5,yStructured[0,0]-0.2), textcoords='data',
            arrowprops=dict(arrowstyle="<|-", color="k", shrinkA=5, shrinkB=0,
                            patchA=None, patchB=None,
                            connectionstyle="arc3,rad=-0.",),)
                            
ax.annotate("", xy=(XL[11],YL[11]), xycoords='data',zorder=50,fontsize=10,
                xytext=(-0.53,-0.094), textcoords='data',
            arrowprops=dict(arrowstyle="-", color="k", shrinkA=0, shrinkB=5,
                            patchA=None, patchB=None,
                            connectionstyle="arc3,rad=0.3",),) 
                            
ax.annotate("", xy=(xStructured[0,0]-0.2, yStructured[0,0]+1), xycoords='data',zorder=50,fontsize=10,
                xytext=(xStructured[0,0]-0.2,yStructured[0,0]+1.5), textcoords='data',
            arrowprops=dict(arrowstyle="<|-", color="k", shrinkA=5, shrinkB=0,
                            patchA=None, patchB=None,
                            connectionstyle="arc3,rad=-0.",),)                              

ax.annotate(r'$\mathbf{x}_p$', xy=[-0.506,-0.075],fontsize=25,zorder=20,backgroundcolor='w')

ax.annotate(r'$(x_{\mathrm{SG}}^{\mathrm{LB}},y_{\mathrm{SG}}^{\mathrm{LB}})$', xy=[xStructured[0,0]-0.45,yStructured[0,0]-0.3],fontsize=15,zorder=20)#,backgroundcolor='w')
...
py.axis([-3.5,2.5,-2.2,1.8])
py.axis('off')
py.savefig('assignStrength_part2.pdf')
#-----------------------------------------------------------
...
##py.scatter(XL,YL,s=100,c='w',lw=1,zorder=5)
py.scatter(XL[11],YL[11],s=1000,c='gray',lw=0.5,zorder=500)
#
#
##xCell = [xStructured[0][4],xStructured[0][5],xStructured[0][5],xStructured[0][4],xStructured[0][4]]
##yCell = [yStructured[3][0],yStructured[3][0],yStructured[4][0],yStructured[4][0],yStructured[3][0]]
#
py.plot([-1,-0.5],[yCell[0],yCell[0]],'c--',zorder=1)
py.plot([-1,-0.5],[yCell[2],yCell[2]],'c--',zorder=1)
py.plot([xCell[0],xCell[0]], [-0.8,-0.4],'c--',zorder=1)
py.plot([xCell[1],xCell[1]], [-0.8,-0.4],'c--',zorder=1)
py.plot(xCell,yCell,'c-',lw=1.5,zorder=100)
py.plot(xCell,yCell,'ro',lw=1.5,markersize=10,zorder=100)
...
ax.annotate("", xy=(XL[11],YL[11]), xycoords='data',zorder=50,fontsize=30,
                xytext=((-0.9+0.25*(XL[11]+0.9)), (-0.8+0.25*(YL[11]+0.8))), textcoords='data',
                arrowprops=dict(arrowstyle="-|>", color="k", shrinkA=0, shrinkB=16,
                                patchA=None, patchB=None,
                                connectionstyle="arc3,rad=-0.",),)
                                
ax.annotate("", xy=(XL[11],YL[11]), xycoords='data',zorder=50,fontsize=30,
                xytext=(xCell[0],yCell[0]), textcoords='data',
                arrowprops=dict(arrowstyle="-|>", color="r", shrinkA=0, shrinkB=16,
                                patchA=None, patchB=None,
                                connectionstyle="arc3,rad=-0.",),)                                

ax.annotate(r'$\mathbf{d}_p$', xy=(-0.8,-0.725),fontsize=20,zorder=20)#,backgroundcolor='w')       

ax.annotate(r'$\mathbf{x}_p$', xy=(-0.769,-0.629),fontsize=25,zorder=20)#,backgroundcolor='w')       


ax.annotate(r'$q_1$', xy=(-0.98,-0.729),fontsize=20,zorder=20,color='r')       
ax.annotate(r'$q_2$', xy=(-0.64,-0.729),fontsize=20,zorder=20,color='r')       
ax.annotate(r'$q_3$', xy=(-0.64,-0.475),fontsize=20,zorder=20,color='r')       
ax.annotate(r'$q_4$', xy=(-0.98,-0.475),fontsize=20,zorder=20,color='r')       

ax.annotate(r'$i,j$', xy=(-0.96,-0.78),fontsize=15,zorder=20,backgroundcolor='0.9')       
ax.annotate(r'$i+1,j$', xy=(-0.675,-0.78),fontsize=15,zorder=20,backgroundcolor='lightgray')       
ax.annotate(r'$i+1,j+1$', xy=(-0.7,-0.43),fontsize=15,zorder=20,backgroundcolor='lightgray')       
ax.annotate(r'$i+1,j$', xy=(-0.97,-0.43),fontsize=15,zorder=20,backgroundcolor='lightgray')       


ax.annotate(r"$\mathbf{d}'_p$", xy=(-0.877,-0.68),fontsize=20,zorder=20)#,backgroundcolor='w')       
#py.plot([XL[11],(-0.9+0.25*(XL[11]+0.9))], [YL[11],(-0.8+0.25*(YL[11]+0.8))],'k-',zorder=1)
py.plot([-0.9,(-0.9+0.25*(XL[11]+0.9))], [-0.8,(-0.8+0.25*(YL[11]+0.8))],'k--',zorder=1)
#py.plot([(XL[11]+0.9)*0.9-XL[11], -0.9], [(YL[11]+0.8)*0.9-YL[11], -0.8],'k--',zorder=1)
       
# Add notation
ax.text(-0.81,-0.43,r'\textsf{4.c}',fontsize=15,zorder=50)                           
ax.add_patch(mpl.patches.Circle((-0.8,-0.425),0.015,fc='0.9',zorder=50))       
       
py.axis('scaled')                                                
py.axis([-1,-0.6,-0.8,-0.4])                            
py.axis('off')
py.savefig('assignStrength_part3.pdf')
#-----------------------------------------------------------
...
plt.pcolormesh(xStructured-2.5,yStructured,wStructured,cmap=colorMapHC,shading='gouraud',zorder=1)#colorMapHC
py.clim(-5,5)         
...
# Plot the blobs inside
py.scatter((XL+2.5)[selected],YL[selected],s=80*0.5,c=WL[selected],lw=1,zorder=4,cmap=colorMapHC)#,norm=norm)
py.clim(-5,5)
