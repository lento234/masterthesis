...
boundaryL = mpl.path.Path(xyBoundaryPoly.T + np.array([-2.5,0]),closed=True)
boundaryR = mpl.path.Path(xyBoundaryPoly.T + np.array([2.5,0]),closed=True)
...
# Plot blobs
py.scatter(xB+0.075,yB,s=200,c='w',lw=0.5,zorder=4)
...
# Plot Interpolation region boundaries
...
# Eulerian boundary
ax.annotate('$\Sigma_d^k$',xy=(1.3,2.),fontsize=20,zorder=10,color='k')
ax.annotate(r'', xy=(0.91,1.59), xycoords='data',fontsize=20,
            xytext=(1.28,2.1),textcoords='data',
            arrowprops=dict(arrowstyle="-", color="k", shrinkA=1, shrinkB=0,
                            patchA=None, patchB=None, connectionstyle="arc3,rad=0.2",),zorder=9)


# Interpolation boundary - outer
ax.annotate('$\Sigma_o^k$',xy=(.3,1.8),fontsize=20,zorder=10,color='k')
ax.annotate(r'', xy=(0.11,1.51), xycoords='data',fontsize=20,
            xytext=(.27,1.9),textcoords='data',
            arrowprops=dict(arrowstyle="-", color="k", shrinkA=1, shrinkB=0,
                            patchA=None, patchB=None, connectionstyle="arc3,rad=0.3",),zorder=9)

# Interpolation boundary - inner
ax.annotate('$\Sigma_i^k$',xy=(-.3,0.6),fontsize=20,zorder=10,color='k')
ax.annotate(r'', xy=(-0.522,0.075), xycoords='data',fontsize=20,
            xytext=(-0.317,0.653),textcoords='data',
            arrowprops=dict(arrowstyle="-", color="k", shrinkA=1, shrinkB=0,
                            patchA=None, patchB=None, connectionstyle="arc3,rad=0.3",),zorder=9)
# Wall boundary
ax.annotate('$\Sigma_w^k$',xy=(-1.1,0.08),fontsize=20,zorder=10,color='k')
ax.annotate(r'', xy=(-0.848,-0.38), xycoords='data',fontsize=20,
            xytext=(-1.07,0.081),textcoords='data',
            arrowprops=dict(arrowstyle="-", color="k", shrinkA=1, shrinkB=0,
                            patchA=None, patchB=None, connectionstyle="arc3,rad=0.4",),zorder=9)


#Plot domains
ax.annotate('$\Omega_I^k$',xy=(1.26,-1.3),fontsize=25,zorder=10,color='k')
ax.annotate(r'', xy=(0.927,-0.725), xycoords='data',fontsize=20,
            xytext=(1.264,-0.979),textcoords='data',
            arrowprops=dict(arrowstyle="-|>", color="k", shrinkA=1, shrinkB=0,
                            patchA=None, patchB=None, connectionstyle="arc3,rad=0.2",),zorder=9)


ax.annotate('$\Omega_E^k$',xy=(1.,-1.9),fontsize=25,zorder=10,color='k')
ax.annotate(r'', xy=(0.754,-1.22), xycoords='data',fontsize=20,
            xytext=(1.019,-1.591),textcoords='data',
            arrowprops=dict(arrowstyle="-|>", color="k", shrinkA=1, shrinkB=0,
                            patchA=None, patchB=None, connectionstyle="arc3,rad=0.1",),zorder=9)

py.savefig('./domainDecomposition_kthDomain.pdf')
'''
# ----------------------------------------------------------
...
# Plot Eulerian grid
py.triplot(xFEI-2.5,yFEI,color='0.75',lw=0.5,zorder=1)
py.triplot(xFEI+2.5,yFEI,color='0.75',lw=0.5,zorder=1)

# Plot ellipse
ax.add_patch(mpl.patches.PathPatch(ellipseL,fill=True,lw=1,facecolor='LightGrey',zorder=3))
ax.add_patch(mpl.patches.PathPatch(ellipseR,fill=True,lw=1,facecolor='LightGrey',zorder=3))

# Plot blobs
py.scatter((xB+0.075)*1.2-2.5,yB,s=70,c='w',lw=0.5,zorder=4)
py.scatter(xB+0.075+2.5,yB,s=70,c='w',lw=0.5,zorder=4)

# Plot interp-region
ax.add_patch(mpl.patches.PathPatch(boundaryL,fill=True,lw=0,facecolor='lawngreen',alpha=0.6,zorder=5))
ax.add_patch(mpl.patches.PathPatch(boundaryR,fill=True,lw=0,facecolor='lawngreen',alpha=0.6,zorder=5))
#col = mpl.collections.PathCollection([interpRegion], lw=0, color='None',facecolor='LightPink', alpha=0.7, zorder=5)
#ax.add_collection(col)
...
# Plot Interpolation region boundaries
#py.plot(xySurfacePoly[0],xySurfacePoly[1],  'r--',zorder=6)
py.plot(xyBoundaryPoly[0]-2.5,xyBoundaryPoly[1],'g--',zorder=6)
py.plot(xyBoundaryPoly[0]+2.5,xyBoundaryPoly[1],'g--',zorder=6)
...
ax.annotate('$\Sigma_o^k$',xy=(.3-2.5,1.8),fontsize=15,zorder=10,color='k')
ax.annotate(r'', xy=(0.11-2.5,1.51), xycoords='data',fontsize=20,
            xytext=(.27-2.5,1.9),textcoords='data',
            arrowprops=dict(arrowstyle="-", color="k", shrinkA=1, shrinkB=0,
                            patchA=None, patchB=None, connectionstyle="arc3,rad=0.3",),zorder=9)


ax.annotate('$\Sigma_o^{k+1}$',xy=(.3+2.5,1.8),fontsize=15,zorder=10,color='k')
ax.annotate(r'', xy=(0.11+2.5,1.51), xycoords='data',fontsize=20,
            xytext=(.27+2.5,1.9),textcoords='data',
            arrowprops=dict(arrowstyle="-", color="k", shrinkA=1, shrinkB=0,
                            patchA=None, patchB=None, connectionstyle="arc3,rad=0.3",),zorder=9)

ax.annotate('$\Omega_E^k$',xy=(-1,2.),fontsize=15,zorder=10,color='k')
ax.annotate(r'', xy=(-1.43112,1.46939), xycoords='data',fontsize=20,
            xytext=(-1.,2.16),textcoords='data',
            arrowprops=dict(arrowstyle="-|>", color="k", shrinkA=1, shrinkB=0,
                            patchA=None, patchB=None, connectionstyle="arc3,rad=0.1",),zorder=9)
                            
ax.annotate('$\Omega_E^{k+1}$',xy=(-1+5.,2.),fontsize=15,zorder=10,color='k')
ax.annotate(r'', xy=(-1.43112+5.,1.46939), xycoords='data',fontsize=20,
            xytext=(-1.+5.,2.16),textcoords='data',
            arrowprops=dict(arrowstyle="-|>", color="k", shrinkA=1, shrinkB=0,
                            patchA=None, patchB=None, connectionstyle="arc3,rad=0.1",),zorder=9)                            
                            


ax.annotate('$\Omega_{in}^{k+1}$',xy=(1.0+2.5,-2.1),fontsize=20,zorder=10,color='DarkGreen')
ax.annotate(r'', xy=(2.99,-0.9), xycoords='data',fontsize=20,
            xytext=(1.019+2.5,-1.591),textcoords='data',
            arrowprops=dict(arrowstyle="-|>", color="DarkGreen", shrinkA=1, shrinkB=0,
                            patchA=None, patchB=None, connectionstyle="arc3,rad=0.1",),zorder=9)                            


ax.annotate('$\Omega_{in}^{k}$',xy=(1.0-2.5,-2.1),fontsize=20,zorder=10,color='DarkGreen')
ax.annotate(r'', xy=(2.99-5,-0.9), xycoords='data',fontsize=20,
            xytext=(1.019-2.5,-1.591),textcoords='data',
            arrowprops=dict(arrowstyle="-|>", color="DarkGreen", shrinkA=1, shrinkB=0,
                            patchA=None, patchB=None, connectionstyle="arc3,rad=0.1",),zorder=9)  


ax.annotate('$\Omega_{out}$',xy=((-4.7+5.2)*0.5-0.1,-2.75),fontsize=20,zorder=10,color='DarkGreen')

py.savefig('./domainDecomposition_correctionDomains.pdf')
