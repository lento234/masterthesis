...
xFELoc, yFELoc = rotate(np.array([xFE,yFE]),theta=-30)
...
xyEllipseLoc = np.array([0.5*widthSurf*np.cos(beta),
...
xyFEBoundaryLoc = np.array([(0.5+np.spacing(1e12))*widthFE*np.cos(beta),
...
ellipseLoc = mpl.path.Path(xyEllipseLoc.T,closed=True)
...
xFEILoc, yFEILoc = rotate(np.array([xFEI,yFEI]),theta=-30)
...
xStructuredLoc = xStructured.copy()
yStructuredLoc = yStructured.copy()
...
# Plot mesh
py.triplot(xFEILoc,yFEILoc,'-',color='0.7',lw=1,zorder=1)


# Plot the structured grid
py.plot(xStructuredLoc,yStructuredLoc,'-',color='cyan',zorder=3,lw=1.5)
py.plot(xStructuredLoc.T,yStructuredLoc.T,'-',color='cyan',zorder=3,lw=1.5)

# Plot boundarries
py.plot(xyEllipseLoc[0],xyEllipseLoc[1],'-',color='k',zorder=10,lw=1)
py.plot(xyFEBoundaryLoc[0],xyFEBoundaryLoc[1],'-',color='k',zorder=2,lw=1)

# Plot square
ax.add_patch(mpl.patches.PathPatch(ellipseLoc,fill=True,lw=0,facecolor='LightGrey',edgecolor='None',zorder=10))



ax.annotate(r"$(x_{\mathrm{SG}}'^{\mathrm{LB}}, y_{\mathrm{SG}}'^{\mathrm{LB}})$", xy=(-2.55,-1.95),fontsize=10,zorder=15)
ax.annotate(r"$(x_{\mathrm{SG}}'^{\mathrm{LB}} + L_x, y_{\mathrm{SG}}'^{\mathrm{LB}})$", xy=(1.5,-1.95),fontsize=10,zorder=15)
ax.annotate(r"$(x_{\mathrm{SG}}'^{\mathrm{LB}}, y_{\mathrm{SG}}'^{\mathrm{LB}} + L_y)$", xy=(-2.9,1.8),fontsize=10,zorder=15)
#ax.annotate(r"$({{x'_{\mathrm{SG}}},y'_{\mathrm{SG}}})$", xy=(-2.55,-1.95),fontsize=13,zorder=15)
#ax.annotate(r"$(x'_{\mathrm{SG}}+L_x,y'_{\mathrm{SG}})$", xy=(1.5,-1.95),fontsize=13,zorder=15)

ax.annotate(r"$L_x$", xy=(-0.2,2.2),fontsize=20,zorder=15)
ax.annotate(r"$L_y$", xy=(-2.9,-0.2),fontsize=20,zorder=15)



ax.annotate("", xy=(xStructuredLoc.flatten().min(), 2.1), xycoords='data',xytext=(xStructuredLoc.flatten().max(),2.1), textcoords='data',
            arrowprops=dict(arrowstyle="<|-|>", color="k", shrinkA=0, shrinkB=0,
                            patchA=None, patchB=None,
                            connectionstyle="arc3,rad=0",),)

ax.annotate("", xy=(-2.5, yStructuredLoc.flatten().min()), xycoords='data',xytext=(-2.5, yStructuredLoc.flatten().max()), textcoords='data',
            arrowprops=dict(arrowstyle="<|-|>", color="k", shrinkA=0, shrinkB=0,
                            patchA=None, patchB=None,
                            connectionstyle="arc3,rad=0",),)


ax.annotate(r"$h$", xy=(xStructuredLoc.flatten().max()+0.2,yStructuredLoc.flatten().max()-0.2),
            fontsize=15,zorder=15)

ax.annotate(r"$h$", xy=(xStructuredLoc.flatten().max()-0.2,yStructuredLoc.flatten().max()+0.2),
            fontsize=15,zorder=15)            
            
ax.annotate("", xy=(2.15, yStructuredLoc[-2][0]), fontsize=5,
            xycoords='data',xytext=(2.15, yStructuredLoc[-1][0]), textcoords='data',
            arrowprops=dict(arrowstyle="<|-|>", color="k", shrinkA=0, shrinkB=0,
                            patchA=None, patchB=None,
                            connectionstyle="arc3,rad=0",),)
                            
ax.annotate("", xy=(xStructuredLoc[0][-2], 1.75), fontsize=5,
            xycoords='data',xytext=(xStructuredLoc[0][-1], 1.75), textcoords='data',
            arrowprops=dict(arrowstyle="<|-|>", color="k", shrinkA=0, shrinkB=0,
                            patchA=None, patchB=None,
                            connectionstyle="arc3,rad=0",),)                            
...
# Draw axis
ax.annotate(r"$y'$", xy=(-0.4,0.4),backgroundcolor='w',color='k',
            fontsize=25,zorder=25)
ax.annotate(r"$x'$", xy=(0.3,-0.4),backgroundcolor='w',color='k',
            fontsize=25,zorder=25)            
            
#ax.annotate(r"$y'$", xy=(xStructuredLoc.flatten().max()+0.2,yStructuredLoc.flatten().max()-0.2),
#            fontsize=15,zorder=15)


ax.annotate("", xy=(0,0), fontsize=20,zorder=100,
            xycoords='data',xytext=(0,0.75), textcoords='data',
            arrowprops=dict(arrowstyle="<|-", color="k", shrinkA=0, shrinkB=0,
                            patchA=None, patchB=None,
                            connectionstyle="arc3,rad=0",),)  
ax.annotate("", xy=(0,0), fontsize=20,zorder=100,
            xycoords='data',xytext=(0.75,0.), textcoords='data',
            arrowprops=dict(arrowstyle="<|-", color="k", shrinkA=0, shrinkB=0,
                            patchA=None, patchB=None,
                            connectionstyle="arc3,rad=0",),)  
...
# Axis formats
py.axis('scaled')
py.axis([-3.5,3.5,-2.5,2.5])
py.axis('off')
py.savefig('structuredGrid_localCoord.pdf')
...
# Plot the structured grid
py.plot(xStructured,yStructured,'-',color='cyan',zorder=3,lw=1.5)
py.plot(xStructured.T,yStructured.T,'-',color='cyan',zorder=3,lw=1.5)
...
# Draw axis
#ax.annotate(r"$y'$", xy=rotate((-0.4,0.4)),backgroundcolor='w',color='k',
#            fontsize=20,zorder=25)
#ax.annotate(r"$x'$", xy=rotate((0.5,0.2)),backgroundcolor='w',color='k',
#            fontsize=20,zorder=25)            
#            
#
#ax.annotate("", xy=rotate((0,0)), fontsize=20,zorder=100,
#            xycoords='data',xytext=rotate((0,0.75)), textcoords='data',
#            arrowprops=dict(arrowstyle="<|-", color="k", shrinkA=0, shrinkB=0,
#                            patchA=None, patchB=None,
#                            connectionstyle="arc3,rad=0",),)  
#ax.annotate("", xy=rotate((0,0)), fontsize=20,zorder=100,
#            xycoords='data',xytext=rotate((0.75,0.)), textcoords='data',
#            arrowprops=dict(arrowstyle="<|-", color="k", shrinkA=0, shrinkB=0,
#                            patchA=None, patchB=None,
#                            connectionstyle="arc3,rad=0",),)  
#
#py.plot([0,2],[0,0],'k',lw=1,zorder=20)
#py.plot([0,2],[0,0],'k',lw=1,zorder=20)
...
ax.annotate("", xy=(1, 0), xycoords='data',xytext=rotate([1.,0.]), textcoords='data',
            arrowprops=dict(arrowstyle="<|-|>", color="k", shrinkA=0, shrinkB=0,
                            patchA=None, patchB=None,
...
#
## Plot mesh
#py.triplot(xFEI,yFEI,'-',color='0.5',lw=1,zorder=1)
#
#
## Plot the structured grid
#py.plot(xStructured,yStructured,'-',color='red',zorder=2,lw=1)
#py.plot(xStructured.T,yStructured.T,'-',color='red',zorder=2,lw=1)
#
#
## Plot square
#ax.add_patch(mpl.patches.PathPatch(ellipse,fill=True,lw=0,facecolor='LightGrey',edgecolor='None',zorder=10))
