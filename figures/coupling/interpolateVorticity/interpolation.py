...
plt.tripcolor(xFEI-2.5,yFEI,wFEI,cmap=colorMapHC,shading='gouraud',zorder=1)
plt.clim(-5,5)
...
# Plot mesh
plt.triplot(xFEI-2.5,yFEI,'-',color='0.5',lw=0.5,zorder=2)

# Plot the structured grid
plt.plot(xStructured+2.5,yStructured,'-',zorder=2,lw=0.5,color='0.5')
plt.plot(xStructured.T+2.5,yStructured.T,'-',zorder=2,lw=0.5,color='0.5')
...
#
## Add annotation
ax.annotate("", xy=(2, 1.7), xycoords='data',xytext=(-1.5, 1.7), textcoords='data',
...
# Plot boundarries
py.plot(xyEllipse[0]-2.5,xyEllipse[1],'-',color='k',zorder=10,lw=1)
py.plot(xyEllipse[0]+2.5,xyEllipse[1],'-',color='k',zorder=10,lw=1)
#py.plot(xyFEBoundary[0]-2.5,xyFEBoundary[1],'-',color='k',zorder=2,lw=1)



# Plot Eulerian boundary
py.plot(xyFEBoundary[0]+2.5,xyFEBoundary[1],'k--',lw=1,zorder=2)
py.plot(xyFEBoundary[0]-2.5,xyFEBoundary[1],'k--',lw=1,zorder=2)

# Plot Text
ax.annotate(r'$\omega$', xy=(-1.6,1.9),fontsize=25,zorder=20)
ax.annotate(r'$\hat{\omega}$', xy=(1.85,1.9),fontsize=25,zorder=20)
ax.annotate(r'$W$', xy=(-0.1,2.2),fontsize=30,zorder=20)
ax.annotate(r'$\mathrm{EG}$', xy=(-3,-2),fontsize=20,color='k',zorder=20)
ax.annotate(r'$\mathrm{SG}$', xy=(3,-2),fontsize=20,color='k',zorder=20)
...
# Axis
plt.axis('scaled')
plt.axis([-4.7,5.2,-3,3])
#plt.axis([-5.5,5.5,-4,4])
plt.axis('off')


py.savefig('interpolation_EG2SG.pdf')
