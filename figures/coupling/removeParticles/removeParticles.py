...
ax.add_patch(mpl.patches.PathPatch(ellipse,fill=True,lw=1,facecolor='LightGrey',zorder=3))
# Plot blobs
insideBBOX = (xB > xyBBOX[0]) & (yB > xyBBOX[1]) & (xB < xyBBOX[2]) & (yB < xyBBOX[3])

py.scatter(xB[~insideBBOX],yB[~insideBBOX],s=100,c='w',lw=1,zorder=5)
py.scatter(xB[insideBBOX],yB[insideBBOX],s=100,c='gray',lw=0.5,zorder=5)
...
#col = mpl.collections.PathCollection([interpRegion], lw=0, color='None',facecolor='LightPink', alpha=0.7, zorder=5)
#ax.add_collection(col)
ax.add_patch(mpl.patches.PathPatch(boundary, lw=0, facecolor='lawngreen', alpha=0.5, zorder=4))
# Plot interp region boundary lines
#py.plot(xySurfacePoly[0],xySurfacePoly[1],'r--',zorder=6)
py.plot(xyBoundaryPoly[0],xyBoundaryPoly[1],'k--',zorder=4)

# Add notation
ax.text(-1,1.8,r'\textsf{2.a}',fontsize=15,zorder=20)                           
...
# Text
ax.annotate('$\Omega_{in}^k$',xy=(-0.216,-2),fontsize=15,zorder=10,color='k')
...
# Text
ax.text(1.27,-2.2,r'$\{ \Omega_{in}^k\}_{BBOX}$', fontsize=15,zorder=20,color='k')                           
...
py.axis('scaled')
py.axis([-3,3,-3,3])
#py.plot([-1.9,3,3,-1.9,-1.9],[-2.25,-2.25,2.15,2.15,-2.25],'r--')
py.axis('off')

py.savefig('removeParticles_part1.pdf')
...
xyBBOX = np.hstack((np.min(xyBoundaryPoly,axis=1),np.max(xyBoundaryPoly,axis=1)))
py.plot([xyBBOX[0],xyBBOX[2],xyBBOX[2],xyBBOX[0],xyBBOX[0]],
        [xyBBOX[1],xyBBOX[1],xyBBOX[3],xyBBOX[3],xyBBOX[1]],'k--',lw=1,zorder=4)
...
# Plot blobs
insideBBOX = (xB > xyBBOX[0]) & (yB > xyBBOX[1]) & (xB < xyBBOX[2]) & (yB < xyBBOX[3])
insideOnlyOne = insideBBOX & ~inside

py.scatter(xB[~insideBBOX],yB[~insideBBOX],s=100,c='w',lw=1,zorder=5,edgecolor='0.75')
py.scatter(xB[insideOnlyOne],yB[insideOnlyOne],s=100,c='w',lw=1,zorder=5)
py.scatter(xB[inside],yB[inside],s=100,c='gray',lw=0.5,zorder=5)
...
# Add notation
#ax.text(-1,1.8,r'$2$',fontsize=15,zorder=20)                           
#ax.add_patch(mpl.patches.Circle((-0.93,1.88),0.15,fc='0.8'))
ax.text(-1,1.8,r'\textsf{2.b}',fontsize=15,zorder=20)                           
ax.add_patch(mpl.patches.Circle((-0.83,1.88),0.25,fc='0.9'))
#ax.text(-1.4,-0.9,r'$2$',fontsize=15,zorder=20)                           
#ax.add_patch(mpl.patches.Circle((-1.34,-0.82),0.15,fc='0.8',zorder=19))
...
ax.annotate(r'', xy=(-0.415,-1.27), xycoords='data',fontsize=20,
            xytext=(-0.216,-1.79),textcoords='data',
            arrowprops=dict(arrowstyle="-|>", color="k", shrinkA=1, shrinkB=0,
                            patchA=None, patchB=None, connectionstyle="arc3,rad=0.1",),zorder=9)  
...
py.axis([-3,3,-3,3])
py.axis('off')
py.savefig('removeParticles_part2.pdf')
...
xyBBOX = np.hstack((np.min(xyBoundaryPoly,axis=1),np.max(xyBoundaryPoly,axis=1)))
#py.plot([xyBBOX[0],xyBBOX[2],xyBBOX[2],xyBBOX[0],xyBBOX[0]],
#        [xyBBOX[1],xyBBOX[1],xyBBOX[3],xyBBOX[3],xyBBOX[1]],'k--',lw=1,zorder=10)
#
...
py.scatter(xB[~insideBBOX],yB[~insideBBOX],s=100,c='w',lw=1,zorder=5)
py.scatter(xB[insideOnlyOne],yB[insideOnlyOne],s=100,c='w',lw=1,zorder=5)
#py.scatter(xB[inside],yB[inside],s=100,c='lightpink',lw=0.5,zorder=5)
...
# Plot interp region boundary lines
#py.plot(xySurfacePoly[0],xySurfacePoly[1],'r--',zorder=6)
py.plot(xyBoundaryPoly[0],xyBoundaryPoly[1],'k--',lw=1,zorder=4)

# Add notation
ax.text(-1,1.8,r'\textsf{2.c}',fontsize=15,zorder=20)                           
ax.add_patch(mpl.patches.Circle((-0.85,1.88),0.25,fc='0.9'))
#ax.text(-1.4,-0.9,r'$2$',fontsize=15,zorder=20)                           
#ax.add_patch(mpl.patches.Circle((-1.34,-0.82),0.15,fc='0.8',zorder=19))
...
py.axis([-3,3,-3,3])
py.axis('off')
py.savefig('removeParticles_part3.pdf')
...
inches_per_pt = 1.0/72.27               # Convert pt to inch
golden_mean = (np.sqrt(5)-1.0)/2.0         # Aesthetic ratio
fig_width = 1.5*3*fig_width_pt*inches_per_pt  # width in inches
...
# Plot Eulerian grid
py.triplot(xFEI-6,yFEI,color='0.5',lw=0.5,zorder=1)

# Plot Eulerian boundary
py.plot(xyFEBoundary[0]-6,xyFEBoundary[1],'k-',lw=0.5,zorder=2)
...
# Plot the bounding box
xyBBOX = np.hstack((np.min(xyBoundaryPoly,axis=1),np.max(xyBoundaryPoly,axis=1)))
py.plot([xyBBOX[0]-6,xyBBOX[2]-6,xyBBOX[2]-6,xyBBOX[0]-6,xyBBOX[0]-6],
        [xyBBOX[1],xyBBOX[1],xyBBOX[3],xyBBOX[3],xyBBOX[1]],'r--',lw=2,zorder=10)



# Plot ellipse
ellipseA = mpl.path.Path(xyEllipse.T + np.array([-6,0]),closed=True)
ax.add_patch(mpl.patches.PathPatch(ellipseA,fill=True,lw=1,facecolor='LightGrey',zorder=3))

# Plot blobs
insideBBOX = (xB > xyBBOX[0]) & (yB > xyBBOX[1]) & (xB < xyBBOX[2]) & (yB < xyBBOX[3])

py.scatter(xB[~insideBBOX]-6,yB[~insideBBOX],s=100,c='w',lw=1,zorder=5)
py.scatter(xB[insideBBOX]-6,yB[insideBBOX],s=100,c='lightpink',lw=0.5,zorder=5)
...
#col = mpl.collections.PathCollection([interpRegion], lw=0, color='None',facecolor='LightPink', alpha=0.7, zorder=5)
#ax.add_collection(col)
boundaryA = mpl.path.Path(xyBoundaryPoly.T + np.array([-6,0]),closed=True)
ax.add_patch(mpl.patches.PathPatch(boundaryA, lw=0, facecolor='lawngreen', alpha=0.5, zorder=4))
# Plot interp region boundary lines
#py.plot(xySurfacePoly[0],xySurfacePoly[1],'r--',zorder=6)
py.plot(xyBoundaryPoly[0]-6,xyBoundaryPoly[1],'k--',zorder=4)

# Add notation
ax.text(-1-6,1.8,r'3.a',fontsize=15,zorder=20)                           
ax.add_patch(mpl.patches.Circle((-0.83-6,1.88),0.25,fc='0.9'))
#ax.text(-1.4,-0.9,r'$2$',fontsize=15,zorder=20)                           
#ax.add_patch(mpl.patches.Circle((-1.34,-0.82),0.15,fc='0.8',zorder=19))


# Text
ax.annotate('$\Omega_{in}^k$',xy=(-0.216-6,-2),fontsize=15,zorder=10,color='k')
ax.annotate(r'', xy=(-0.415-6,-1.27), xycoords='data',fontsize=20,
            xytext=(-0.216-6,-1.79),textcoords='data',
            arrowprops=dict(arrowstyle="-|>", color="k", shrinkA=1, shrinkB=0,
                            patchA=None, patchB=None, connectionstyle="arc3,rad=0.1",),zorder=50)  
            
# Text
ax.text(1.27-6,-2.2,r'$\{ \Omega_{in}^k\}_{BBOX}$', fontsize=15,zorder=20,color='k')                           
ax.annotate('', xy=(0.8399-6,-1.561), xycoords='data',fontsize=20,xytext=(1.284-6, -2.005), textcoords='data',
           arrowprops=dict(arrowstyle="-", color="k", shrinkA=0, shrinkB=0,
                           patchA=None, patchB=None,
                           connectionstyle="arc3,rad=-0.2",),zorder=50)
...
ax.annotate('', xy=(-1.95,-0.15), xycoords='data',fontsize=15,xytext=(-2.8, -0.15), textcoords='data',
           arrowprops=dict(arrowstyle="simple", color="k", shrinkA=0, shrinkB=0,
                           patchA=None, patchB=None,
                           connectionstyle="arc3,rad=0.",),zorder=50)
...
ax.annotate('', xy=(-1.95,0.15), xycoords='data',fontsize=15,xytext=(-2.8, 0.15), textcoords='data',
           arrowprops=dict(arrowstyle="simple", color="k", shrinkA=0, shrinkB=0,
                           ...
                           connectionstyle="arc3,rad=0.",),zorder=50)                           
#                           
ax.annotate('', xy=(4.,0.15), xycoords='data',fontsize=15,xytext=(3.2, 0.15), textcoords='data',
           arrowprops=dict(arrowstyle="simple", color='k', shrinkA=0, shrinkB=0,
                           patchA=None, patchB=None,
                           connectionstyle="arc3,rad=0.",),zorder=50)      
...
py.axis('scaled')
py.axis([-9,9.5,-3,3])
#py.plot([-1.9,3.1,3.1,-1.9,-1.9],[-2.25,-2.25,2.2,2.2,-2.25],'r--')
#py.plot(np.array([-1.9,3.1,3.1,-1.9,-1.9])-6.,[-2.25,-2.25,2.2,2.2,-2.25],'r--')
#py.plot(np.array([-1.9,3.1,3.1,-1.9,-1.9])+6.,[-2.25,-2.25,2.2,2.2,-2.25],'r--')
...
# Plot interp region boundary lines
#py.plot(xySurfacePoly[0],xySurfacePoly[1],'r--',zorder=6)
py.plot(xyBoundaryPoly[0],xyBoundaryPoly[1],'r--',lw=2,zorder=4)


# Add notation
#ax.text(-1,1.8,r'$2$',fontsize=15,zorder=20)                           
#ax.add_patch(mpl.patches.Circle((-0.93,1.88),0.15,fc='0.8'))
ax.text(-1,1.8,r'3.b',fontsize=15,zorder=20)                           
ax.add_patch(mpl.patches.Circle((-0.83,1.88),0.25,fc='0.9'))
#ax.text(-1.4,-0.9,r'$2$',fontsize=15,zorder=20)                           
#ax.add_patch(mpl.patches.Circle((-1.34,-0.82),0.15,fc='0.8',zorder=19))
...
# Plot ellipse
ellipseB = mpl.path.Path(xyEllipse.T + np.array([6,0]),closed=True)
ax.add_patch(mpl.patches.PathPatch(ellipseB,fill=True,lw=1,facecolor='LightGrey',zorder=3))
# Plot blobs
insideBBOX = (xB > xyBBOX[0]) & (yB > xyBBOX[1]) & (xB < xyBBOX[2]) & (yB < xyBBOX[3])
insideOnlyOne = insideBBOX & ~inside

#py.scatter(xB[~insideBBOX],yB[~insideBBOX],s=100,c='w',lw=1,zorder=5)
#py.scatter(xB[insideOnlyOne]+6,yB[insideOnlyOne],s=100,c='w',lw=1,zorder=5)
py.scatter(xB[~inside]+6,yB[~inside],s=100,c='w',lw=1,zorder=5)
...
#col = mpl.collections.PathCollection([interpRegion], lw=0, color='None',facecolor='LightPink', alpha=0.7, zorder=5)
#ax.add_collection(col)
boundaryB = mpl.path.Path(xyBoundaryPoly.T + np.array([6,0]),closed=True)
ax.add_patch(mpl.patches.PathPatch(boundaryB, lw=0, facecolor='lawngreen', alpha=0.5, zorder=4))
# Plot interp region boundary lines
#py.plot(xySurfacePoly[0],xySurfacePoly[1],'r--',zorder=6)
py.plot(xyBoundaryPoly[0]+6,xyBoundaryPoly[1],'k--',lw=1,zorder=4)

# Add notation
ax.text(-1+6,1.8,r'3.c',fontsize=15,zorder=20)                           
ax.add_patch(mpl.patches.Circle((-0.85+6,1.88),0.25,fc='0.9'))
#ax.text(-1.4,-0.9,r'$2$',fontsize=15,zorder=20)                           
#ax.add_patch(mpl.patches.Circle((-1.34,-0.82),0.15,fc='0.8',zorder=19))
...
'''
py.axis('off')
py.savefig('removeParticles_full.pdf')
