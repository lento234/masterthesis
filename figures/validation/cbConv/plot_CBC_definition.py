...
# Mesh parameters
meshFilePath            = './data_nBlob200/mesh.xml.gz'
boundaryDomainsFilePath = './data_nBlob200/mesh_facet_region.xml.gz'
...
# Define the domains
xyFEPoly = np.array([[xBounds[0],xBounds[1],xBounds[1],xBounds[0],xBounds[0]],
...
ax.axis('scaled')
ax.axis([-1.,1.,-0.55,0.55])
ax.axis('off')

# Add text
#ax.annotate(r'$\Omega_{E} \subseteq \Omega_L$', xy=(-0.2, -0.465),fontsize=10,backgroundcolor='w')

ax.annotate(r'$\Omega_{I}$', xy=(-0.01, -0.35),fontsize=20,backgroundcolor='None',color='r')
            #bbox=dict(boxstyle='square', fc="w", ec="none"))#,fontsize=25,zorder=20)
ax.annotate(r'$\Omega_{L} \backslash \Omega_E$', xy=(-0.5, 0.3),fontsize=15,backgroundcolor='w')
            #bbox=dict(boxstyle='square', fc="w", ec="none"))#,fontsize=25,zorder=20)
#ax.annotate(r'$\partial \Omega_{dirich}$', xy=(0.6, 0.4),fontsize=10)#,fontsize=25,zorder=20)

ax.annotate(r'$\Omega_{E}$', xy=(0.21, 0.3), xycoords='data',fontsize=15,xytext=(0.35, 0.4), textcoords='data',
           arrowprops=dict(arrowstyle="->", color="k", shrinkA=5, shrinkB=5,
                           patchA=None, patchB=None,
                           connectionstyle="arc3,rad=-0.2",),)

ax.annotate(r'$p_{+}$', xy=(-0.95, 0.15),fontsize=15)
ax.annotate(r'$p_{-}$', xy=(-0.95, -0.15),fontsize=15)


#ax.annotate(r'$\Sigma_{int}$', xy=(0.3, 0.365), xycoords='data',fontsize=10,xytext=(0.4, 0.6), textcoords='data',
#           arrowprops=dict(arrowstyle="->", color="k", shrinkA=5, shrinkB=5,
#                           patchA=None, patchB=None,
#                           connectionstyle="arc3,rad=0.2",),)

#$\d_{bdry}$
#ax.annotate(r'$d_{bdry}{\cdot}{h}$', xy=(-0.175, 0.44),fontsize=8,backgroundcolor='w')
...
# Axis
ax.annotate("",(0.+0.01,0.-0.02),(0.+0.01,0.15-0.02),arrowprops={'arrowstyle':'<|-','fc':'k','ec':'k'})
ax.annotate("",(0.,0.-0.01),(0.15,0.-0.01),arrowprops={'arrowstyle':'<|-','fc':'k','ec':'k'})


py.scatter([-0.75,-0.75],[-0.1,0.1],s=2000,c=['CornflowerBlue','Salmon'])

py.plot([-0.75],[0.1],'k+')
py.plot([-0.75],[-0.1],'k_')

#ax.annotate(r'', xy=(-0.8, -0.0), xycoords='data',fontsize=8,xytext=(-0.8, -0.2), textcoords='data',
...
ax.annotate(r'', xy=(-0.75+0.1, 0.175), xycoords='data',fontsize=8,xytext=(-0.75-.1, 0.175), textcoords='data',
           arrowprops=dict(arrowstyle="<|-", color="r", shrinkA=5, shrinkB=5,
                           patchA=None, patchB=None,
                           connectionstyle="arc3,rad=-0.6",),)
...
ax.annotate("",(-0.7,0.),(-0.5,0.),arrowprops={'arrowstyle':'<|-','fc':'r','ec':'r'})
