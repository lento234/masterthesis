...
ax.add_patch(mpl.patches.PathPatch(squareN,fill=True,lw=1,facecolor='LightGrey',zorder=3))
...
xyBlobsTemp = np.hstack((xyBlobsTemp[:,:13],xyBlobsTemp[:,14:]))

#xyBlobsTemp[1] -= 0.75
py.scatter(xyBlobsTemp[0],
           -xyBlobsTemp[1],s=600,c='w',lw=0.5,zorder=4)


# Plot boundaries:

# Plot Eulerian boundary
py.plot(xyFEBoundary[0],xyFEBoundary[1]*0.5,'k-',lw=1.5,zorder=2)

py.plot(xySquare[0],xySquare[1]*0.5,'k-',lw=1.5,zorder=2)
...
py.plot([-1, 1, 1, -1, -1],[0.7,0.7,1.3,1.3,0.7],'r--',lw='1.5',zorder=10)
...
ax.annotate(r'$\Omega_{I}$', xy=(-0.5, 0.93),fontsize=40,zorder=10,color='r')


# Surface
ax.annotate(r'$d_{surf}$', xy=(-0.65, 0.57),fontsize=20,zorder=10,color='r')
ax.annotate(r'', xy=(-0.7,0.5), xycoords='data',fontsize=20,
            xytext=(-0.7,0.7),textcoords='data',
            arrowprops=dict(arrowstyle="<|-|>", color="r", shrinkA=1, shrinkB=0,
                            patchA=None, patchB=None, connectionstyle="arc3,rad=0.",),zorder=9)

# Boundary
ax.annotate(r'$d_{bdry}$', xy=(-0.65, 1.37),fontsize=20,zorder=10,color='r')
ax.annotate(r'', xy=(-0.7,1.3), xycoords='data',fontsize=20,
            xytext=(-0.7,1.5),textcoords='data',
            arrowprops=dict(arrowstyle="<|-|>", color="r", shrinkA=1, shrinkB=0,
                            patchA=None, patchB=None, connectionstyle="arc3,rad=0.",),zorder=9)
...
# Add text
ax.annotate(r'$\Sigma_{w}$', xy=(0.38, 0.55),fontsize=30,zorder=10,backgroundcolor='None')

ax.annotate(r'$\Sigma_{i}$', xy=(0.38, 0.75),fontsize=30,zorder=10,backgroundcolor='None')
ax.annotate(r'$\Sigma_{o}$', xy=(0.38, 1.35),fontsize=30,zorder=10,backgroundcolor='None')

ax.annotate(r'$\Sigma_{d}$', xy=(0.38, 1.55),fontsize=30,zorder=10,backgroundcolor='None')
...
# Body
ax.annotate(r'\textsf{body}$', xy=(-0.075, 0.4),fontsize=15,zorder=10,backgroundcolor='w')
