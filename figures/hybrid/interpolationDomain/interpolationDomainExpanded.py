...
#ax.annotate('$\Omega_{int}$',xy=(0.,0.8),fontsize=25,zorder=10)

# Eulerian domain
ax.annotate('$\Omega_{E}$',xy=(-0.35,-1.25),fontsize=25,zorder=10)
ax.annotate(r'', xy=(xyEllipse[0,150],xyEllipse[1,150]), xycoords='data',fontsize=20,
            xytext=(xyFEBoundary[0,150],xyFEBoundary[1,150]),textcoords='data',
            arrowprops=dict(arrowstyle="<|-", color="k", shrinkA=1, shrinkB=0,
                            patchA=None, patchB=None, connectionstyle="arc3,rad=0.",),zorder=9)

# Eulerian domain
ax.annotate('$\Omega_{L}$',xy=(1.55,-1.1),fontsize=25,zorder=10)
ax.annotate(r'', xy=(xyEllipse[0,300],xyEllipse[1,300]), xycoords='data',fontsize=20,
...
# Eulerian domain
ax.annotate('$\Omega_{I}$',xy=(-0.35,0.75),fontsize=25,zorder=10,color='r')
ax.annotate(r'', xy=(xySurfacePoly[0,-250],xySurfacePoly[1,-250]), xycoords='data',fontsize=20,
            xytext=(xyBoundaryPoly[0,-250],xyBoundaryPoly[1,-250]),textcoords='data',
