...
\mscName{M.Y.N. Ame B.Sc.}%
\mscDate{My Graduation Date}%
\mscTitle{The Main Title Of the Thesis}%
\mscSubTitle{A Subtitle to Enlighten the Reader}% can be left empty
\mscKeyWords{a whole bunch of keywords,separated,by,commas}%
%
